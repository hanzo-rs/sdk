...
/// struct for typed errors of method [`get_v1_releases`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetV1ReleasesError {
...
pub async fn get_v1_releases(configuration: &configuration::Configuration, ) -> Result<(), Error<GetV1ReleasesError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let entity: Option<GetV1ReleasesError> = serde_json::from_str(&content).ok();
