...
/// struct for typed errors of method [`delete_v1_kv_name`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum DeleteV1KvNameError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`get_v1_kv`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetV1KvError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`get_v1_kv_name`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetV1KvNameError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`post_v1_kv`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum PostV1KvError {
    UnknownValue(serde_json::Value),
}
...
pub async fn delete_v1_kv_name(configuration: &configuration::Configuration, name: &str) -> Result<(), Error<DeleteV1KvNameError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let entity: Option<DeleteV1KvNameError> = serde_json::from_str(&content).ok();
...
pub async fn get_v1_kv(configuration: &configuration::Configuration, ) -> Result<Vec<models::ProvisionedSummary>, Error<GetV1KvError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GetV1KvError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn get_v1_kv_name(configuration: &configuration::Configuration, name: &str) -> Result<models::ProvisionedResource, Error<GetV1KvNameError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_name = name;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GetV1KvNameError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn post_v1_kv(configuration: &configuration::Configuration, provision_request: Option<models::ProvisionRequest>) -> Result<models::ProvisionResult, Error<PostV1KvError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<PostV1KvError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
