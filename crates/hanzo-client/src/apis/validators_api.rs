...
/// struct for typed errors of method [`get_v1_validators`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetV1ValidatorsError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`get_v1_validators_challenge`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetV1ValidatorsChallengeError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`get_v1_validators_token_id`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetV1ValidatorsTokenIdError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`post_v1_validators`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum PostV1ValidatorsError {
    UnknownValue(serde_json::Value),
}
...
pub async fn get_v1_validators(configuration: &configuration::Configuration, limit: Option<&str>) -> Result<models::ValidatorList, Error<GetV1ValidatorsError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GetV1ValidatorsError> = serde_json::from_str(&content).ok();
...
pub async fn get_v1_validators_challenge(configuration: &configuration::Configuration, token_id: Option<&str>) -> Result<models::ChallengeView, Error<GetV1ValidatorsChallengeError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GetV1ValidatorsChallengeError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn get_v1_validators_token_id(configuration: &configuration::Configuration, token_id: &str) -> Result<models::SlotView, Error<GetV1ValidatorsTokenIdError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_token_id = token_id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GetV1ValidatorsTokenIdError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn post_v1_validators(configuration: &configuration::Configuration, validator_claim: models::ValidatorClaim) -> Result<models::SlotView, Error<PostV1ValidatorsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<PostV1ValidatorsError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
