...
/// struct for typed errors of method [`get_v1_usage_activity`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetV1UsageActivityError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`get_v1_usage_analytics`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetV1UsageAnalyticsError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`get_v1_usage_analytics_access`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetV1UsageAnalyticsAccessError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`get_v1_usage_leaderboard`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetV1UsageLeaderboardError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`get_v1_usage_leaderboard_optin`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetV1UsageLeaderboardOptinError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`get_v1_usage_samples`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetV1UsageSamplesError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`get_v1_usage_summary`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetV1UsageSummaryError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`post_v1_usage`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum PostV1UsageError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`post_v1_usage_rollup_backfill`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum PostV1UsageRollupBackfillError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`put_v1_usage_leaderboard_optin`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum PutV1UsageLeaderboardOptinError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`put_v1_usage_leaderboard_optin_org`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum PutV1UsageLeaderboardOptinOrgError {
    UnknownValue(serde_json::Value),
}
...
pub async fn get_v1_usage_activity(configuration: &configuration::Configuration, subject: Option<&str>, id: Option<&str>, from: Option<&str>, to: Option<&str>) -> Result<models::ActivityView, Error<GetV1UsageActivityError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GetV1UsageActivityError> = serde_json::from_str(&content).ok();
...
pub async fn get_v1_usage_analytics(configuration: &configuration::Configuration, end: Option<&str>, plan: Option<&str>, range: Option<&str>, start: Option<&str>) -> Result<models::UsageAnalyticsView, Error<GetV1UsageAnalyticsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_end = end;
    let p_plan = plan;
    let p_range = range;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::UsageAnalyticsView`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::UsageAnalyticsView`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<GetV1UsageAnalyticsError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn get_v1_usage_analytics_access(configuration: &configuration::Configuration, plan: Option<&str>) -> Result<models::UsageAnalyticsAccess, Error<GetV1UsageAnalyticsAccessError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_plan = plan;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::UsageAnalyticsAccess`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::UsageAnalyticsAccess`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<GetV1UsageAnalyticsAccessError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn get_v1_usage_leaderboard(configuration: &configuration::Configuration, scope: Option<&str>, metric: Option<&str>, period: Option<&str>, limit: Option<i32>) -> Result<models::LeaderboardView, Error<GetV1UsageLeaderboardError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_scope = scope;
    let p_metric = metric;
    let p_period = period;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GetV1UsageLeaderboardError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn get_v1_usage_leaderboard_optin(configuration: &configuration::Configuration, ) -> Result<models::OptinView, Error<GetV1UsageLeaderboardOptinError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GetV1UsageLeaderboardOptinError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn get_v1_usage_samples(configuration: &configuration::Configuration, account: Option<&str>, provider: Option<&str>, range: Option<&str>, window: Option<&str>) -> Result<models::DashResp, Error<GetV1UsageSamplesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::DashResp`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::DashResp`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<GetV1UsageSamplesError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn get_v1_usage_summary(configuration: &configuration::Configuration, range: Option<&str>, start: Option<&str>, end: Option<&str>) -> Result<models::UsageSummary, Error<GetV1UsageSummaryError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_range = range;
    let p_start = start;
    let p_end = end;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GetV1UsageSummaryError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn post_v1_usage(configuration: &configuration::Configuration, report_req: models::ReportReq) -> Result<models::ReportResp, Error<PostV1UsageError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_report_req = report_req;
    ...
    req_builder = req_builder.json(&p_report_req);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::ReportResp`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::ReportResp`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<PostV1UsageError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn post_v1_usage_rollup_backfill(configuration: &configuration::Configuration, backfill_query: models::BackfillQuery) -> Result<models::BackfillResult, Error<PostV1UsageRollupBackfillError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_backfill_query = backfill_query;
    ...
    req_builder = req_builder.json(&p_backfill_query);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::BackfillResult`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::BackfillResult`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<PostV1UsageRollupBackfillError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn put_v1_usage_leaderboard_optin(configuration: &configuration::Configuration, user_optin_req: models::UserOptinReq) -> Result<models::UserOptinView, Error<PutV1UsageLeaderboardOptinError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<PutV1UsageLeaderboardOptinError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn put_v1_usage_leaderboard_optin_org(configuration: &configuration::Configuration, org_optin_req: models::OrgOptinReq) -> Result<models::OrgOptinView, Error<PutV1UsageLeaderboardOptinOrgError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<PutV1UsageLeaderboardOptinOrgError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
