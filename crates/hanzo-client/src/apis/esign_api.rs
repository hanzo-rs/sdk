...
/// struct for typed errors of method [`get_v1_esign_documents`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetV1EsignDocumentsError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`get_v1_esign_documents_by_id`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetV1EsignDocumentsByIdError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`get_v1_esign_documents_by_id_audit`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetV1EsignDocumentsByIdAuditError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`get_v1_esign_documents_by_id_download`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetV1EsignDocumentsByIdDownloadError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`get_v1_esign_health`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetV1EsignHealthError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`get_v1_esign_oby_org_sign_by_token`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetV1EsignObyOrgSignByTokenError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`post_v1_esign_documents`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum PostV1EsignDocumentsError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`post_v1_esign_documents_by_id_fields`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum PostV1EsignDocumentsByIdFieldsError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`post_v1_esign_documents_by_id_recipients`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum PostV1EsignDocumentsByIdRecipientsError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`post_v1_esign_documents_by_id_send`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum PostV1EsignDocumentsByIdSendError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`post_v1_esign_oby_org_sign_by_token_complete`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum PostV1EsignObyOrgSignByTokenCompleteError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`post_v1_esign_oby_org_sign_by_token_fields_by_fieldid`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum PostV1EsignObyOrgSignByTokenFieldsByFieldidError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`post_v1_esign_oby_org_sign_by_token_reject`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum PostV1EsignObyOrgSignByTokenRejectError {
    UnknownValue(serde_json::Value),
}
...
pub async fn get_v1_esign_documents(configuration: &configuration::Configuration, ) -> Result<(), Error<GetV1EsignDocumentsError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let entity: Option<GetV1EsignDocumentsError> = serde_json::from_str(&content).ok();
...
pub async fn get_v1_esign_documents_by_id(configuration: &configuration::Configuration, id: &str) -> Result<(), Error<GetV1EsignDocumentsByIdError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GetV1EsignDocumentsByIdError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn get_v1_esign_documents_by_id_audit(configuration: &configuration::Configuration, id: &str) -> Result<(), Error<GetV1EsignDocumentsByIdAuditError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GetV1EsignDocumentsByIdAuditError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn get_v1_esign_documents_by_id_download(configuration: &configuration::Configuration, id: &str) -> Result<(), Error<GetV1EsignDocumentsByIdDownloadError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GetV1EsignDocumentsByIdDownloadError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn get_v1_esign_health(configuration: &configuration::Configuration, ) -> Result<(), Error<GetV1EsignHealthError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GetV1EsignHealthError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn get_v1_esign_oby_org_sign_by_token(configuration: &configuration::Configuration, org: &str, token: &str) -> Result<(), Error<GetV1EsignObyOrgSignByTokenError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_org = org;
    let p_token = token;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GetV1EsignObyOrgSignByTokenError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn post_v1_esign_documents(configuration: &configuration::Configuration, ) -> Result<(), Error<PostV1EsignDocumentsError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<PostV1EsignDocumentsError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn post_v1_esign_documents_by_id_fields(configuration: &configuration::Configuration, id: &str) -> Result<(), Error<PostV1EsignDocumentsByIdFieldsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<PostV1EsignDocumentsByIdFieldsError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn post_v1_esign_documents_by_id_recipients(configuration: &configuration::Configuration, id: &str) -> Result<(), Error<PostV1EsignDocumentsByIdRecipientsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<PostV1EsignDocumentsByIdRecipientsError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn post_v1_esign_documents_by_id_send(configuration: &configuration::Configuration, id: &str) -> Result<(), Error<PostV1EsignDocumentsByIdSendError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<PostV1EsignDocumentsByIdSendError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn post_v1_esign_oby_org_sign_by_token_complete(configuration: &configuration::Configuration, org: &str, token: &str) -> Result<(), Error<PostV1EsignObyOrgSignByTokenCompleteError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_org = org;
    let p_token = token;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<PostV1EsignObyOrgSignByTokenCompleteError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn post_v1_esign_oby_org_sign_by_token_fields_by_fieldid(configuration: &configuration::Configuration, org: &str, token: &str, field_id: &str) -> Result<(), Error<PostV1EsignObyOrgSignByTokenFieldsByFieldidError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_org = org;
    let p_token = token;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<PostV1EsignObyOrgSignByTokenFieldsByFieldidError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn post_v1_esign_oby_org_sign_by_token_reject(configuration: &configuration::Configuration, org: &str, token: &str) -> Result<(), Error<PostV1EsignObyOrgSignByTokenRejectError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_org = org;
    let p_token = token;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<PostV1EsignObyOrgSignByTokenRejectError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
