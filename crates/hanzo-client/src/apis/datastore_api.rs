...
/// struct for typed errors of method [`delete_v1_datastore_name`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum DeleteV1DatastoreNameError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`get_v1_datastore`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetV1DatastoreError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`get_v1_datastore_name`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetV1DatastoreNameError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`post_v1_datastore`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum PostV1DatastoreError {
    UnknownValue(serde_json::Value),
}
...
pub async fn delete_v1_datastore_name(configuration: &configuration::Configuration, name: &str) -> Result<(), Error<DeleteV1DatastoreNameError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let entity: Option<DeleteV1DatastoreNameError> = serde_json::from_str(&content).ok();
...
pub async fn get_v1_datastore(configuration: &configuration::Configuration, ) -> Result<Vec<models::ProvisionedSummary>, Error<GetV1DatastoreError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GetV1DatastoreError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn get_v1_datastore_name(configuration: &configuration::Configuration, name: &str) -> Result<models::ProvisionedResource, Error<GetV1DatastoreNameError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_name = name;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GetV1DatastoreNameError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn post_v1_datastore(configuration: &configuration::Configuration, provision_request: Option<models::ProvisionRequest>) -> Result<models::ProvisionResult, Error<PostV1DatastoreError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<PostV1DatastoreError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
