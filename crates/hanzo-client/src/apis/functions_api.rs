...
/// struct for typed errors of method [`delete_v1_functions_by_name`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum DeleteV1FunctionsByNameError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`get_v1_functions`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetV1FunctionsError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`get_v1_functions_by_name`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetV1FunctionsByNameError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`get_v1_functions_by_name_invocations`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetV1FunctionsByNameInvocationsError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`get_v1_functions_by_name_logs`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetV1FunctionsByNameLogsError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`get_v1_functions_deployments`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetV1FunctionsDeploymentsError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`get_v1_functions_metrics`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetV1FunctionsMetricsError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`get_v1_functions_secrets`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetV1FunctionsSecretsError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`get_v1_functions_triggers`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetV1FunctionsTriggersError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`post_v1_functions`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum PostV1FunctionsError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`post_v1_functions_by_name_invoke`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum PostV1FunctionsByNameInvokeError {
    UnknownValue(serde_json::Value),
}
...
pub async fn delete_v1_functions_by_name(configuration: &configuration::Configuration, name: &str) -> Result<(), Error<DeleteV1FunctionsByNameError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let entity: Option<DeleteV1FunctionsByNameError> = serde_json::from_str(&content).ok();
...
pub async fn get_v1_functions(configuration: &configuration::Configuration, ) -> Result<(), Error<GetV1FunctionsError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GetV1FunctionsError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn get_v1_functions_by_name(configuration: &configuration::Configuration, name: &str) -> Result<(), Error<GetV1FunctionsByNameError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_name = name;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GetV1FunctionsByNameError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn get_v1_functions_by_name_invocations(configuration: &configuration::Configuration, name: &str) -> Result<(), Error<GetV1FunctionsByNameInvocationsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_name = name;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GetV1FunctionsByNameInvocationsError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn get_v1_functions_by_name_logs(configuration: &configuration::Configuration, name: &str) -> Result<(), Error<GetV1FunctionsByNameLogsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_name = name;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GetV1FunctionsByNameLogsError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn get_v1_functions_deployments(configuration: &configuration::Configuration, ) -> Result<(), Error<GetV1FunctionsDeploymentsError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GetV1FunctionsDeploymentsError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn get_v1_functions_metrics(configuration: &configuration::Configuration, ) -> Result<(), Error<GetV1FunctionsMetricsError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GetV1FunctionsMetricsError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn get_v1_functions_secrets(configuration: &configuration::Configuration, ) -> Result<(), Error<GetV1FunctionsSecretsError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GetV1FunctionsSecretsError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn get_v1_functions_triggers(configuration: &configuration::Configuration, ) -> Result<(), Error<GetV1FunctionsTriggersError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GetV1FunctionsTriggersError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn post_v1_functions(configuration: &configuration::Configuration, ) -> Result<(), Error<PostV1FunctionsError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<PostV1FunctionsError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn post_v1_functions_by_name_invoke(configuration: &configuration::Configuration, name: &str) -> Result<(), Error<PostV1FunctionsByNameInvokeError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_name = name;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<PostV1FunctionsByNameInvokeError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
