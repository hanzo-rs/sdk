...
pub struct IamPeriodUpdateOrganizationInput {
...
impl IamPeriodUpdateOrganizationInput {
    pub fn new() -> IamPeriodUpdateOrganizationInput {
        IamPeriodUpdateOrganizationInput {
            account_items: None,
            account_menu: None,
            balance_credit: None,
