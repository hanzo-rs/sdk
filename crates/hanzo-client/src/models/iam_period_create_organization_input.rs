...
pub struct IamPeriodCreateOrganizationInput {
...
impl IamPeriodCreateOrganizationInput {
    pub fn new() -> IamPeriodCreateOrganizationInput {
        IamPeriodCreateOrganizationInput {
            account_items: None,
            account_menu: None,
            balance_credit: None,
